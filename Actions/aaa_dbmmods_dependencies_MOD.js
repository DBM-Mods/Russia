  ...
  installModule (moduleName) {
    return new Promise((resolve) => {
      ...
      try {
        ...
        console.log(`Не удалось установить ${moduleName}, попробуйте еще раз или установите вручную с помощью "npm i ${moduleName}"`)
      }
    })
  },
...
module.exports = {
  ...
  html () {
    ...
    <div id ="wrexdiv" style="width: 550px; height: 350px; overflow-y: scroll;">
      <p>
        <u>Зависимости DBM MODS</u><br><br>
        Это не действие, но обязательно для действий данной категории.<br><br>
        <b>Создание этого действия ничего не даст</b>
      </p>
    </div>`
  },
