module.exports = {
  ...
  subtitle(data) {
    const storeTypes = ['', 'Временная переменная', 'Переменная сервера', 'Глобальная переменная', 'Параметры команды'];
    return `Преобразовать текст ${storeTypes[parseInt(data.storage, 10)]} (${data.varName}) в список ${
...
<div style="display: table; width: 105%;">
  ...
  <span class="dbminputlabel">Разделитель</span>
