module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return data.description
      ...
      : `<font style="color:${desccor}">Всего(${data.total}) Элементы на странице(${data.pag})</font>`
  },
...
<span class="dbminputlabel">Всего элементов</span><br>
<input id="total" class="round" type="text" value="">
</td><td class="td2">
<span class="dbminputlabel">Элементы на странице</span>
...
<br>
    ...
    <table><tr><td class="td1">
    <span class="dbminputlabel">Храните общую страницу в</span><br>
...
<table><tr><td class="td1">
<span class="dbminputlabel">Сохраните номер начального элемента в</span><br>
...
<table><tr><td class="td1">
<span class="dbminputlabel">Страница магазина в</span><br>
