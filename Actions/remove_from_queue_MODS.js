module.exports = {
	...
	subtitle(data, presets) {
		...
		return data.description
		  ...
		  : `<font style="color:${desccor}">Удалить ${data.amount} аудио</font>`
	  },
	  ...
	  html: function (isEvent, data) {
		...
		<td class="sep1">
		  <span class="dbminputlabel">Позиция</span><br>
			<input id="position" type="text" class="round" value="0" placeholder="Начните с 0">
		  </td>
		  <td class="sep2">
		  <span class="dbminputlabel">Количество для удаления</span><br>
