...
<div>
  ...
  <span class="dbminputlabel">Ширина кадрирования (px или %)</span><br>
    <input id="width" class="round" type="text" value="100%"><br>
  </div>
  <div style="float: right; width: 50%;padding:5px">
  <span class="dbminputlabel">Высота среза (px или %)</span><br>
  ...
  <span class="dbminputlabel">Выравнивание</span><br>
    ...
    <option value="4">Центральный центр</option>
    ...
    <option value="9">Конкретное положение</option>
    </select><br>
  </div>
  <div id="specific" style="display: none; float: left; width: 100%;">
  <span class="dbminputlabel">Пользовательское выравнивание</span><br>
