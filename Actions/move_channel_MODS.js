module.exports = {
  ...
  html(isEvent, data) {
      ...
      <table style="width:100%;">
        <tr>
          ...
          <td style="padding:0px 0px 0px 10px;width:70px">
            <div style="float:left;padding:0px 0px 0px 7px;margin-top:-5px"><dbm-checkbox id="descriptionx" label="Цвет (вкл)"></dbm-checkbox></div>
            <br>
    ...
    <table>
      <tr>
        <td class="xin1">
          <span class="dbminputlabel">Перемещаемый канал</span><br>
          ...
          <option value="3">Позиция канала</option>
		      </select>
        </td>
        <td class="xin2"><div id="oculta3">
          <span class="dbminputlabel" id="xinxylaalter">Значение</span><br>
          <input id="find" class="round" type="text"></div>
        </td>
      </tr>

      <tr>
        <td class="xin1">
          <span class="dbminputlabel">Переместить в другую категорию</span><br>
        ...
        <td class="xin2">
          <div id="oculta">
            ...
            <input id="find2" class="round" type="text">
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td class="xin1">
          <span class="dbminputlabel">Переместить на другую позицию</span><br>
    ...
    <div id="oculta4">
      <span class="dbminputlabel">Права канала</span><br>
      <select id="sync" class="round">
        ...
        <option value="2">Сохранить права канала</option>
      </select>
      <br>
    </div>
    ...
    <div>
      <table>
        <tr>
          <td class="col1">
            <span class="dbminputlabel">Хранить ошибку</span><br>
          ...
          <td class="col2">
            <div id="varerrsv">
              ...
              <input id="errv" class="round" type="text">
            </div>
          </td>
        </tr>
      </table>
    ...
    <div>
      <div style="float: left; width: 38%" id="xinext">
        <span class="dbminputlabel">Если возникнет ошибка</span><br>
      ...
      <div id="iffalseContainer" style="display: none; float: right; width: 60%;">
        <div id="xincontrol">
          <span id="xinelas" class="dbminputlabel">Для</span><br>
...
`;
  ...
  init: function () {
    ...
    glob.onComparisonChanged4 = function (event) {
      ...
      if (event.value == "1") {
        document.getElementById("oculta3").style.display = null;
        document.querySelector("[id='xinxylaalter']").innerText = (`Имя`);
      }
      if (event.value == "2") {
        document.getElementById("oculta3").style.display = null;
        document.querySelector("[id='xinxylaalter']").innerText = (`Тема`);
      }
      if (event.value == "3") {
        document.getElementById("oculta3").style.display = null;
