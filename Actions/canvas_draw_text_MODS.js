...
<br>
	...
	<div style="padding-top:12px">
					...
					<table style="width:100%">
						<tr>
							<td style="width:33% !important">
								<span class="dbminputlabel">Х позиция</span><br>
							...
							<td style="width:33% !important">
								<span class="dbminputlabel">Выравнивание</span><br>
								<select id="align" class="round" style="width: 100%;">
									<option value="0" selected>Верхний левый</option>
									<option value="1">Верхний центр</option>
									<option value="2">В правом верхнем углу</option>
									<option value="3">Средний левый</option>
									<option value="4">Центр</option>
									<option value="5">Средний правый</option>
									<option value="6">Нижний левый</option>
									<option value="7">Нижний центр</option>
									<option value="8">Нижний правый</option>
								</select>
							</td>
						</tr>
					</table>
		...
		<div style="padding-top:12px">
		<span class="dbminputlabel">Повернуть текст</span>
		<div style="width:100%;background:rgba(50,50,50,0.5);-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;padding:8px 4px">
		<table style="width:100%"><tr>
		<td style="width:33% !important">
		<span class="dbminputlabel">Повернуть (градусы)</span><br>
			<input id="rotacionar" class="round" type="text" value="0">
		</td>

		<td style="width:33% !important">
		<span class="dbminputlabel">Коррекция Х</span><br>
			<input id="x2" class="round" type="text" value="0">
		</td>

		<td style="width:33% !important">
		<span class="dbminputlabel">Коррекция Y</span><br>
	...
	<tab label="Цвет" icon="flask">
		...
		<div id="cor" style="padding-top:15px">
					<span class="dbminputlabel">Основной Цвет</span><br>
					<table style="width:100%"><tr><th><input value="#FFFFFF" id="fontColor" name="actionxinxyla" class="round" type="text" placeholder="По желанию"><th>
	...
	<tab label="Край" icon="block layout">
	<div style="padding-top:12px">
		...
		<span class="dbminputlabel">Тип края</span><br>
			...
			<option value="0" selected>Никакой</option>
				<option value="1">Цвет границы (HEX или RGBA)</option>
				<option value="2">Градиентный край</option>
		</select>

<div id="bordadoxinxyla" style="padding-top:15px">
		<span class="dbminputlabel">Размер края</span><br>
		<input id="borda" class="round" type="text" placeholder="Необходимый"></div>

		<div id="gradienteborda" style="padding-top:15px">
			<span class="dbminputlabel">Градиентный край</span>
		...
		<div id="corborda" style="padding-top:15px">
					...
					<table style="width:100%"><tr><th><input value="#FFFFFF" id="bordacor" name="actionxinxyla" class="round" type="text" placeholder="По желанию"><th>
	...
	<tab label="Тень" icon="cloud">
		<div style="padding-top:12px">
		<span class="dbminputlabel">Тип тени</span><br>
		<select id="shadowtipo" class="round" onchange="glob.onChange3(this)">
		<option value="0" selected>Никакой</option>
			<option value="1">Цвет тени (HEX или RGBA)</option>
	</select>
	<div id="shadow" style="padding-top:15px">
	<table style="width:100%"><tr>
	<td style="width:100px">
	<span class="dbminputlabel">Пятно тени</span><br>
	<input id="blur" class="round" type="text" value="0" placeholder="Необходимый">
	</td>
	...
	<tab label="Определения" icon="cogs">
		...
		<td style="width:48%">
		<span class="dbminputlabel">Размер текста</span><br>
			<input id="fontSize" class="round" type="text" placeholder="Размер по умолчанию 10 пикселей">
		</td>
</tr></table><br>


<span class="dbminputlabel">Тип ширины</span>
<div style="width:100%;background:rgba(50,50,50,0.5);-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;padding:8px 4px">
<select id="menulargura" class="round" onchange="glob.onChange1(this)">
<option value="0" selected>Никакой</option>
<option value="1">Фиксированная ширина</option>
<option value="2">Максимальная ширина</option>
<option value="3">Максимальная ширина без разрыва слов</option>
</select>

<div id="xinelas01" style="padding-top:12px">
<span class="dbminputlabel">Фиксированная ширина</span><br>
<input id="largura" class="round" type="text" placeholder="Необходимый">
</div>
<div id="xinelas02" style="padding-top:12px">
<table style="width:100%"><tr>
<td style="width:50%">
<span class="dbminputlabel">Максимальная ширина</span><br>
<input id="larguramax" class="round" type="text" placeholder="Необходимый">
</td>
<td style="width:50%">
<span class="dbminputlabel">Расстояние высота</span><br>
<input id="distancia" class="round" type="text" placeholder="По желанию">
</td>
</tr></table>
</div>
