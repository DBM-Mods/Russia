module.exports = {
  ...
  subtitle(data, presets) {
    const info = [`"ID: ${data.find}"`, `"Имя: ${data.find}"`];
    return `Переместить категорию ${info[parseInt(data.info, 10)]} на позицию "${data.posicao}"`;
  },
  ...
  html(isEvent, data) {
    ...
    <table>
    <tr>
    <td class="xin1"><span class="dbminputlabel">Категория</span><br>
...
<span class="dbminputlabel">Позиция</span><br>
    ...
    <option value="1">Прекратить последовательность действий</option>
