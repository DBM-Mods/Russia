...
<td class="col1">
<span class="dbminputlabel">Начало заполнено</span>
<input id="cheioi" class="round" type="text" placeholder="Альтернативный">
</td>

<td>
<span class="dbminputlabel">Центр заполнено</span>
<input id="cheio" class="round" type="text" placeholder="Пусто по умолчанию">
</td>

<td class="col2">
<span class="dbminputlabel">Конец заполнено</span>
<input id="cheiof" class="round" type="text" placeholder="Альтернативный">
</td>
...
<br>
    ...
    <td class="col1">
    <span class="dbminputlabel">Начало пустое</span>
    <input id="vazioi" class="round" type="text" placeholder="Альтернативный">
    </td>

    <td>
<span class="dbminputlabel">Центр пустое</span>
<input id="vazio" class="round" type="text" placeholder="Пусто по умолчанию">
</td>

<td class="col2">
<span class="dbminputlabel">Конец пустое</span>
<input id="vaziof" class="round" type="text" placeholder="Альтернативный">
</td>
...
<td class="col1">
    ...
    <span class="dbminputlabel">Размер прогресс бара</span>
    <input id="tamanho" class="round" type="text" placeholder="Пусто по умолчанию">

    </td><td class="col2">

<span class="dbminputlabel">Процент проресса</span>
<input id="pc" class="round" type="text">
	  </td></tr></table>

    <br>

    <span class="dbminputlabel">Тип вывода проресс бара</span><br>
<select id="type" class="round">
  <option value="0" selected>Горизонтально вправо</option>
  <option value="1">Горизонтально влево</option>
  <option value="2">Вертикально вверх</option>
  <option value="3">Вертикальный вниз</option>
</select>
