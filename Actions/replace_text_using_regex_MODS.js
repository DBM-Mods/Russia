module.exports = {
    ...
    html(isEvent, data) {
        return `
          ...
          <span class="dbminputlabel">Оригинальный текст</span>
          <textarea id="text" rows="4" placeholder="Введите текст здесь ..."></textarea>
         ...
         <br>
          ...
          <span class="dbminputlabel">Заменить для</span>
          <textarea id="text2" rows="3" placeholder="Введите текст здесь ..."></textarea>
  
          <br>
  
          <span class="dbminputlabel">Конфигурация</span>
          <div style="display: flex; justify-content: center; align-items: center; background: #333; padding: 5px; border-radius: 5px;">
            <dbm-checkbox id="global" label="Глобальный" checked></dbm-checkbox>
            <dbm-checkbox id="insensitive" label="Игнорировать заглавные буквы" checked></dbm-checkbox>
          </div>
