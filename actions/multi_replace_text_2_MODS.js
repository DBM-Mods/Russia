module.exports = {
  ...
  return `${info[data.info]} текста "${data.text}"`;
  },
  ...
  html(isEvent, data) {
    ...
    <div>
	  <span class="dbminputlabel">Текст</span>
		  <textarea id="text" rows="4" placeholder="Введите текст здесь..." style="width: 99%; font-family: monospace; white-space: nowrap;"></textarea>
	  </div>
	  <div>
<br>
<div style="float: left; width: 45%;">
		<span class="dbminputlabel">Список для замен > из</span><br>
    ...
    <div style="float: left; width: 45%;">
		<span class="dbminputlabel">Список для замен > на</span><br>
