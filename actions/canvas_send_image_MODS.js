module.exports = {
  ...
  subtitle(data, presets) {
    return `${presets.getSendTargetText(data.channel, data.varName2)} - Изображение холста (${data.varName})`;
  },
...
<span class="dbminputlabel">Сообщение</span><br>
  <textarea id="message" rows="1" placeholder="Введите ваше сообщение здесь..." style="width: 100%"></textarea>
</div><br>
<div>
  <div style="float: left; width: 50%;">
  <span class="dbminputlabel">Изображение спойлера</span><br>
...
<div>
<br>
  <div id="embed1"><table><tr><td><span class="dbminputlabel">Объект Embed</span><br>
    <select id="storage4" class="round">
      ${data.variables[1]}
    </select>
  </td><td><span class="dbminputlabel">Имя Переменной</span><br>
    <input id="varName4" placeholder="По желанию" class="round" type="text" list="variableList">
  </td></tr></table>
  </div><br>
  <div style="float: left; width: 35%;">
