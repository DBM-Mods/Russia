module.exports = {
  ...
  html(isEvent, data) {
    ...
    <tab-system style="margin-top: 5px;">
        ...
        <tab label="JSON и конфигурация" icon="align left">
...
<span class="dbminputlabel">Имя объекта</span><br>
	...
	<div style="float: left; width: 45%;">
		...
		<select id="addType" class="round" onchange="glob.onChange1(this)">
			...
			<option value="2">Добавить в определённой позиции</option>
		</select>
	</div>
...
<tab label="Объект" icon="align left">
<div style="padding:8px">

    <dialog-list id="itens" fields='["item","valor"]' dialogTitle="Информация об объекте" dialogResizable dialogWidth="500" dialogHeight="510" listLabel="Информация об объекте" listStyle="height: calc(100vh - 280px);" itemName="Item" itemCols="1" itemHeight="40px;" itemTextFunction="data.item + ' = ' + data.valor" itemStyle="text-align: left; line-height: 40px;">
