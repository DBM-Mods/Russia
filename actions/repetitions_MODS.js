module.exports = {
    ...
    return `Количество повторений "${data.palavra}"`;
    },
    ...
    html: function(isEvent, data) {
        ...
        <textarea id="texto" placeholder="Введите текст здесь..." rows="5" style="resize:none"></textarea>
        <br>
        <span class="dbminputlabel">Слово</span>
        <input id="palavra" type="text" class="round" placeholder="Введите слово здесь...">
        <br>
        <div style="float:left; width:45%;">
            <span class="dbminputlabel">Игнорировать регистр букв</span>
        ...
        <div style="float:right; width:50%;">
            <span class="dbminputlabel">Игнорировать акценты</span>
