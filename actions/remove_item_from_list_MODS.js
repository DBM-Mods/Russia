module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return `Удалить элемент ${storage[parseInt(data.storage, 10)]} (${data.varName})`;
  },
...
<div>
	<div style="float: left; width: 100%;">
		<span class="dbminputlabel">Тип удаления</span><br>
      ...
      <option value="3">Удалить несколько элементов</option>
      <option value="4">Удалить все элементы, равные</option>
      <option value="5">Удалить все элементы, содержащие</option>
		</select><br>
	</div>
  ...
  <span class="dbminputlabel">Количество удаляемых элементов</span><br>
...
<store-in-variable allowNone dropdownLabel="Сохранить в" style="padding-top: 8px;" selectId="storage2" variableInputId="varName2" variableContainerId="varNameContainer2"></store-in-variable>`;
  },
