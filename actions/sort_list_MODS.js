module.exports = {
	...
	subtitle: function (data) {
		...
		const list = ['', 'Временная переменная', 'Серверная переменная', 'Глобальная переменная '];
		const classic = ['Порядок возрастания [0-9]', 'Порядок убыванния [9-0]', 'Алфавитный порядок [A-Z]', 'Обратный алфавитный порядок [Z-A]', 'Длина [по возрастанию]', 'Длина [в порядке убывания]'];
...
<br>
	...
	<div>
		...
		<span class="dbminputlabel">Сортировка списка</span><br>
