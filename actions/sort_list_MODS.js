module.exports = {
	...
	<div>
		...
		<span class="dbminputlabel">Сортировать список</span><br>
			...
			<option value="0" selected>Сортировать числа по возрастанию [0-9]</option>
            <option value="1">Сортировать числа по убыванию [9-0]</option>
            <option value="2">Сортировать по алфавиту [A-Z]</option>
            <option value="3">Сортировать по алфавиту в обратном порядке [Z-A]</option>
