...
<span class="dbminputlabel">Действие</span><br>
    ...
    <span class="dbminputlabel">Ключ шифрования</span><br>
  <input id="key" class="round" type="text">


  <br>

<span class="dbminputlabel" id="xinxyla">Текст или код</span>
...
.td2{padding:0px 0px 0px 8px}
  ...
  init() {
    ...
    glob.onChange1 = function (event) {
      ...
      if (value == 0) {
        document.querySelector("[id='xinxyla']").innerText = (`Зашифровать текст`);
      } else {
        document.querySelector("[id='xinxyla']").innerText = (`Расшифровывать код`);
      }
    };
