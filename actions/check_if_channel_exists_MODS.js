  ...
  html(isEvent, data) {
    ...
    <div>
      <div style="float: left; width: 40%;">
        <span class="dbminputlabel">Поиск по</span><br>
        <select id="info" class="round">
          <option value="0" selected>ID</option>
          <option value="1">Названию</option>
          <option value="2">Теме канала</option>
          <option value="3">Позиции канала</option>
          <option value="4">ID категории канала</option>
        </select>
      </div>
      <div style="float: right; width: 55%;">
        <span class="dbminputlabel">Введите туть...</span><br>
    ...
    <dbm-checkbox id="voz" label="Включить голосовые каналы" checked></dbm-checkbox></td>
