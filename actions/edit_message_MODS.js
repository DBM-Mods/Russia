...
<div style="padding-top: 8px;">
	<span class="dbminputlabel">Изменить содержание сообщения</span><div>
...
<div id="varNameContainer2" style=" width: 100%;">
  <span class="dbminputlabel">Укажите количество эмбедов</span><br>
...
<br>
  <div id="embed1"><table><tr><td><span class="dbminputlabel">Объект эмбеда</span><br>
    <select id="storage2" class="round">
      ${data.variables[1]}
    </select>
  </td><td><span class="dbminputlabel">Имя переменной</span><br>
    <input id="varName2" placeholder="Обязательно" class="round" type="text" list="variableList">
  </td></tr></table>
  </div>


  <div id="embed2" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 2</span><br>
    <select id="storage3" class="round">
      ${data.variables[1]}
    </select>
    </td><td><span class="dbminputlabel">Имя переменной</span><br>
    <input id="varName3" placeholder="Обязательно" class="round" type="text" list="variableList">
  </td></tr></table>
  </div>

  <div id="embed3" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 3</span><br>
  <select id="storage4" class="round">
    ${data.variables[1]}
  </select>
  </td><td><span class="dbminputlabel">Имя переменной</span><br>
  <input id="varName4" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed4" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 4</span><br>
<select id="storage5" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName5" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed5" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 5</span><br>
<select id="storage6" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName6" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed6" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 6</span><br>
<select id="storage7" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName7" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed7" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 7</span><br>
<select id="storage8" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName8" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed8" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 8</span><br>
<select id="storage9" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName9" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed9" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 9</span><br>
<select id="storage10" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName10" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>

<div id="embed10" style="display:none"><table><tr><td><span class="dbminputlabel">Объект эмбеда 10</span><br>
<select id="storage11" class="round">
  ${data.variables[1]}
</select>
</td><td><span class="dbminputlabel">Имя переменной</span><br>
<input id="varName11" placeholder="Обязательно" class="round" type="text" list="variableList">
</td></tr></table>
</div>
