...
<div>
  ...
  <span class="dbminputlabel">Ширина обрезки (px или %)</span><br>
    <input id="width" class="round" type="text" value="100%"><br>
  </div>
  <div style="float: right; width: 50%;padding:0px 0px 0px 5px">
  <span class="dbminputlabel">Высота обрезки (px или %)</span><br>
  ...
  <span class="dbminputlabel">Выравнивание</span><br>
    ...
    <option value="0" selected>Верхняя левая часть</option>
    <option value="1">Верхний центр</option>
    <option value="2">Правый верхний угол</option>
    <option value="3">Средний левый</option>
    <option value="4">Центр</option>
    <option value="5">Среднее право</option>
    <option value="6">Нижний левый</option>
    <option value="7">Нижний центр</option>
    <option value="8">Нижняя правая часть</option>
    <option value="9">Конкретная позиция</option>
    </select><br>
  </div>

  <div id="specific" style="display: none; float: left; width: 100%;">
  <span class="dbminputlabel">Индивидуальное выравнивание</span><br>
