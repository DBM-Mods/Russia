...
<td style="padding:0px 0px 0px 10px;width:70px"><div style="float:left;padding:0px 0px 0px 7px;margin-top:-5px"><dbm-checkbox id="descriptionx" label="Цвет (вкл)"></dbm-checkbox></div><br><input type="color" value="#ffffff" class="round" id="descriptioncolor"></td>
  ...
  <div style="padding-top: 8px;">
    <div style="float: left; width: 40%;">
    <span class="dbminputlabel">Редактировать заголовок</span><br>
      <select id="Edit0" class="round" onchange="glob.onChange0(this)">
        ...
        <option value="2">Очистить содержимое</option>
      </select>
    </div>
  ...
  <div style="padding-top: 8px;">
    <div style="width: 40%;">
    <span class="dbminputlabel">Редактировать описание</span><br>
  ...
  <div style="padding-top: 8px;">
    ...
    <span class="dbminputlabel">Редактировать URL изоб</span><br>
      <select id="Edit4" class="round" onchange="glob.onChange4(this)">
        ...
        <option value=1>Редактировать содержимое</option>
        <option value=2>Очистить содержимое</option>
        <option value=3>Редактировать содержимое (Local)</option>
      </select>
    </div>
    <div id="Input4" style="display: none; float: right; width: 55%;">
      <div id="Input4placeholder"><span class="dbminputlabel">URL изображения</span></div>
      <input id="imageUrl" class="round" type="text">
    </div>
  </div><br><br><br>
  <div id="Input4a" style="display: none; padding-top: 8px;">
  <div style="float: left; width: 105%;">
  <span class="dbminputlabel">Имя с расширением</span><br>
  ...
  <div style="padding-top: 8px;">
    <div style="float: left; width: 40%;">
    <span class="dbminputlabel">Редактировать имя автора</span><br>
    ...
    <span class="dbminputlabel">Имя автора</span><br>
...
<div style="padding-top: 8px;">
  ...
  <div style="padding-top: 8px;">
    ...
    <span class="dbminputlabel">Редактировать Timestamp</span><br>
      <select id="Edit11" class="round" onchange="glob.onChange11(this)">
        ...
        <option value=2>Редактировать на строку временной метки</option>
        <option value=3>Очистить содержимое</option>
      </select>
    </div>
  ...
  <div style="padding-top: 8px;">
    <div style="float: left; width: 40%;">
    <span class="dbminputlabel">Редактировать поля</span><br>
      <select id="Edit12" class="round" onchange="glob.onChange12(this)">
        <option value=0 selected>Сохранить содержание</option>
        <option value=1>Редактировать содержание</option>
        <option value=2>Удалить поле</option>
        <option value=3>Удалить все поля</option>
        <option value=4>Добавить новое поле</option>
      </select><br>
    </div>
  ...
  <div id="Input13" style="display: none;">
    ...
    <span class="dbminputlabel">Редакт поле в строке?</span><br>
      <select id="fieldInline" class="round">
        <option value=0 selected>Держать в линии</option>
        <option value=1>Да</option>
        <option value=2>Нет</option>
      </select><br>
    </div><br><br><br><br>
    <div style="width: 100%;">
    <span class="dbminputlabel">Редактировать значение поля</span><br>
    ...
    glob.onChange4 = function onChange4(Edit4) {
      switch (parseInt(Edit4.value, 10)) {
        ...
        case 1:
          ...
          Input4placeholder.innerHTML = 'URL изображения:';
    ...
    glob.onChange5 = function onChange5(Edit5) {
      switch (parseInt(Edit5.value, 10)) {
        ...
        case 1:
          ...
          Input5placeholder.innerHTML = 'URL изображения:';
          document.getElementById('thumbUrl').value = '';
          Input5a.style.display = 'none';
          break;
        case 3:
          Input5.style.display = null;
          Input5placeholder.innerHTML = 'Локальный путь:';
