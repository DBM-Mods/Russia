module.exports = {
  ...
  subtitle(data, presets) {
    ...
    : `<font style="color:${desccor}">Преобразовать "${data.date}" в формат "${data.format2}" ${storage[parseInt(data.storage, 10)]} (${data.varName})</font>`
  },
...
<td style="padding:0px 0px 0px 10px;width:70px"><div style="float:left;padding:0px 0px 0px 7px;margin-top:-5px"><dbm-checkbox id="descriptionx" label="Цвет (вкл)"></dbm-checkbox></div><br><input type="color" value="#ffffff" class="round" id="descriptioncolor"></td>
    ...
    <div style="width: 100%">
      <span class="dbminputlabel">Формат даты (<span class="xinelaslink" data-url="https://momentjs.com/docs/#/displaying/format/">Документ</span>)</span>
      <input type="text" id="format" class="round" placeholder="Прим: MM/DD/YYYY HH:mm:ss">
    </div>
 
  <div style="width: 100%; padding-top: 16px;">
  <span class="dbminputlabel">Дата</span>
  <input id="date" class="round" type="text" placeholder='22/02/2022 22:22:22'></div>

    <div style="width: 100%;padding-top: 16px;">
      <span class="dbminputlabel">Конвертировать в формат (<span class="xinelaslink" data-url="https://momentjs.com/docs/#/displaying/format/">Документ</span>)</span>
      <input type="text" id="format2" class="round" placeholder="Прим: DD/MM/YYYY HH:mm:ss">
    </div>
