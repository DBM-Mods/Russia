module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return data.description
      ...
      : `<font style="color:${desccor}">Удаление ${data.count} сообщений в ${presets.getChannelText(data.channel, data.varName)}</font>`
  },
...
<br>
    ...
    <span class="dbminputlabel">Количество для удаления</span>
  ...
  <tab label="Сохронение и ошибки" icon="file image">
  <div style="width: 100%; padding:8px;height: calc(100vh - 210px);overflow:auto">

  <div style="padding:0px 0px 15px 0px">
  <table style="width:100%;"><tr>
  <td><span class="dbminputlabel">Описание действия</span><br><input type="text" class="round" id="description" placeholder="Необезательно!"></td>
  <td style="padding:0px 0px 0px 10px;width:70px"><div style="float:left;padding:0px 0px 0px 7px;margin-top:-5px"><dbm-checkbox id="descriptionx" label="Цвет"></dbm-checkbox></div><br><input type="color" value="#ffffff" class="round" id="descriptioncolor"></td>
  </tr></table>
  </div>
