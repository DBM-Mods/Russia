module.exports = {
  ...
  subtitle(data, presets) {
    ...
    return data.description
      ...
      : `<font style="color:${desccor}">Сохранить в "${data.Path}${data.fileName}"</font>`
  },
...
<div>
  ...
  <span class="dbminputlabel">Папка для сохранения</span><br>
...
<input id="fileName" class="round" value="image.png" type="text" placeholder="image.png">
<br>
<div>
  <div style="float: left; width: 40%;">
  <span class="dbminputlabel">Храните в</span><br>
