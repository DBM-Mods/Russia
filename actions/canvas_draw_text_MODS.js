module.exports = {
	...
	<br>
		...
		<div style="padding-top:12px">
			...
			<td style="width:33% !important">
			<span class="dbminputlabel">Коррекция X</span><br>
		...
		<tab label="Цвет" icon="flask">
			...
			<span class="dbminputlabel">Тип цвета</span>
				<select id="tipocor" class="round" onchange="glob.onChange0(this)">
					...
					<option value="1">Градиентовый цвет</option>
			</select>
		...
		<tab label="Граница" icon="block layout">
		<div style="padding-top:12px">
	...
	<div id="bordadoxinxyla" style="padding-top:15px">
			...
			<input id="borda" class="round" type="text" placeholder="Необходимо"></div>
	...
	<input id="largura" class="round" type="text" placeholder="Необходимо">
	</div>
	<div id="xinelas02" style="padding-top:12px">
	<table style="width:100%"><tr>
	<td style="width:50%">
	<span class="dbminputlabel">Максимальная ширина</span><br>
	<input id="larguramax" class="round" type="text" placeholder="Необходимо">
	</td>
	<td style="width:50%">
	<span class="dbminputlabel">Расстояние высоты</span><br>
